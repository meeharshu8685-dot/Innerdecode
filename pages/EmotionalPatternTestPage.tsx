...
const EmotionalPatternTestPage: React.FC = () => {
  ...
  const handleComplete = (answers: Answer[]) => {
    ...
    navigate(`/test-result/emotional/${resultId}`);
  };
  ...
  return (
    <div>
        <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-slate-800 dark:text-slate-200 mb-4">Emotional Pattern Test</h1>
            <p className="max-w-2xl mx-auto text-lg text-text-secondary dark:text-slate-400">Understand your default emotional responses. Knowing your pattern is the first step toward greater emotional regulation and resilience.</p>
        </div>
