  ...
  return (
    <div>
        <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-slate-800 dark:text-slate-200 mb-4">Core Problem Identifier</h1>
            <p className="max-w-2xl mx-auto text-lg text-text-secondary dark:text-slate-400">Answer a few simple questions to understand the pattern of the problem you're facing. This will help us guide you to the right solution.</p>
        </div>
        <Quiz 
