...
const AboutPage: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-lg">
      <h1 className="text-4xl font-bold text-slate-800 dark:text-slate-200 mb-6 text-center">About Innerdecode</h1>
      <div className="space-y-8 text-lg text-text-secondary dark:text-slate-300">
        <section>
          <h2 className="text-2xl font-semibold text-text-primary dark:text-slate-200 mb-3">Our Purpose</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-text-primary dark:text-slate-200 mb-3">The Non-AI Principle</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-text-primary dark:text-slate-200 mb-3">The Science of Patterns</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-text-primary dark:text-slate-200 mb-3">Your Journey to Self-Understanding</h2>
          <p>
